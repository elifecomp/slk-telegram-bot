...
MOTIVATION = [
    ...
    "⭐ Твои возможности безграничны — действуй!",
    "🔥 Энергия нового дня заряжена на успех!",
    "🌈 Каждое утро — это новый шанс изменить мир.",
    "🎯 Сфокусируйся на главном — остальное подождёт.",
    "🏆 Победители начинают с веры в себя.",
    "💡 Идеи приходят к тем, кто действует!",
    "🌟 Пусть этот день принесёт радость и удачу!",
    "⚡ Твой VPN уже работает — пора сворачивать горы!",
]
